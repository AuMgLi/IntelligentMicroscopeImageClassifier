...
def predict(models_path, image_dir, labels_filename, labels_nums, data_format):
    ...
    images_list = glob.glob(os.path.join(image_dir, '*.*'))
...
if __name__ == '__main__':
    class_nums = 3
    image_dir = 'img4model_prediction/'
    labels_filename = 'img4model_prediction/pred_label.txt'
    models_path = 'D:/PycharmProjects/testCNN_after1218/models/best_models_12200_0.9784.ckpt'
